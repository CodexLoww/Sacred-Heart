...
<div class="row">
	...
	<div class="col-6 pt-2 text-center">
		...
		<hr>
	<div class="col-md-12 text-center">
		<a href="church-expenses" class="text-decoration-none text-light">More Info</a> <i class="fas fa-arrow-circle-right"></i>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-6 pt-4 text-center">
		...
		<hr>
	<div class="col-md-12 text-center">
		<a href="certificates" class="text-decoration-none text-light">More Info</a> <i class="fas fa-arrow-circle-right"></i>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-6 pt-2 text-center">
		...
		<hr>
	<div class="col-md-12 text-center">
		<a href="baptismal" class="text-decoration-none text-light">More Info</a> <i class="fas fa-arrow-circle-right"></i>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-6 pt-2 text-center">
		...
		<hr>
	<div class="col-md-12 text-center">
		<a href="mass-intention" class="text-decoration-none text-light">More Info</a> <i class="fas fa-arrow-circle-right"></i>
	</div>
</div>
