...
<a id="<?= $row_baptismal["baptismal_id"]; ?>" href="#" type="button" class="btn btn-outline-success btn-sm deleteBaptist-data" data-bs-toggle="modal" data-bs-target="#modalApprove<?= $row_baptismal['baptismal_id'] ?>"><i class="fa-solid fa-check"></i></a>

<div class="modal fade" id="modalApprove<?= $row_baptismal['baptismal_id'] ?>" aria-hidden="true" aria-labelledby="exampleToggle" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <!-- modal header -->
            <div class="modal-header">
                <h3 class="text-success">Approve Baptismal</h3>
            ...
            <div class="modal-body">
                <p>Are you sure you approve to this Baptismal record?</p>
                <input type="hidden" name="approve_baptismal_id" value="<?= $row_baptismal['baptismal_id'] ?>">
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="del_baptismal_idMain" value="<?= $row_baptismal['baptismal_id'] ?>">
                <!-- You can display additional information or details here -->
            </div>
